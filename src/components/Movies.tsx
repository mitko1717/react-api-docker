...
const Movies = () => {
  ...
  // if (!data || !data.data || !data.data.length) return <div className="font-bold text-center text-2xl">there is no results. add some movies or change search params</div>;
